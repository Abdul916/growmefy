...
Route::get('/landing/{slug}', function ($slug) {
    ...
    return view('business.landing', compact('business'));
});

Route::get('/review/{slug}', function ($slug) {
    $business = Business::where('slug', $slug)->firstOrFail();
    return view('business.review', compact('business'));
});

Route::get('/feedback/{slug}', function ($slug) {
    $business = Business::where('slug', $slug)->firstOrFail();
    return view('business.feedback', compact('business'));
});
